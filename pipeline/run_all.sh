...
python3 correct_census.py     # correct facilitator-multiplication inflation
python3 coverage_join.py      # DELTA 2a: Bazaar vs index coverage
python3 classify_census.py    # Phase 2 pass 1 (census-level buckets, corrected)
...
python3 correct_census.py     # re-run: attach deep-validation evidence
